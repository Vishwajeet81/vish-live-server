...
- Fixed an issue where Live Preview always opened the project's default page instead of the selected HTML file.
- Live Preview now correctly opens the HTML file you choose from the Explorer.
